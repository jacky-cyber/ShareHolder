	...
	public static void d(String TAG, String message) {
		...
		if (DEBUG) {
			...
			if (elements.length < 3) {
				...
				String methodName = elements[3].getMethodName();
				int lineNumber = elements[3].getLineNumber();
				android.util.Log.d(className + "." + methodName + "():"
						+ lineNumber, message);
			}
		} else {
	...
	public static void i(String TAG, String message) {
		...
		if (DEBUG) {
			...
			if (elements.length < 3) {
				...
				String methodName = elements[3].getMethodName();
				int lineNumber = elements[3].getLineNumber();
				android.util.Log.i(className + "." + methodName + "():"
						+ lineNumber, message);
			}
		} else {
	...
	public static void w(String TAG, String message) {
		...
		if (DEBUG) {
			...
			if (elements.length < 3) {
				...
				String methodName = elements[3].getMethodName();
				int lineNumber = elements[3].getLineNumber();
				android.util.Log.w(className + "." + methodName + "():"
						+ lineNumber, message);
			}
		} else {
	...
	public static void v(String TAG, String message) {
		...
		if (DEBUG) {
			...
			if (elements.length < 3) {
				...
				String methodName = elements[3].getMethodName();
				int lineNumber = elements[3].getLineNumber();
				android.util.Log.v(className + "." + methodName + "():"
						+ lineNumber, message);
			}
		} else {
