...
public class PullToRefreshView extends LinearLayout {
	...
	public void setmFooterTextView(TextView mFooterTextView) {
		this.mFooterTextView = mFooterTextView;
	}
	 ...
	 * @description
	 * @param adapter
	 *            .context hylin 2012-7-26上午10:08:33
	 */
	private void init() {
	...
	protected void onFinishInflate() {
		...
		if(FOOTERENABLE){addFooterView();
		initContentAdapterView();
		}
	}
    public void setFooterEnable(Boolean boo){
    	if(boo==false){
