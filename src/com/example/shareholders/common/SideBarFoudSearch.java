...
public class SideBarFoudSearch extends View {
	// �����¼�
	...
	public SideBarFoudSearch(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public SideBarFoudSearch(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SideBarFoudSearch(Context context) {
		super(context);
	}
