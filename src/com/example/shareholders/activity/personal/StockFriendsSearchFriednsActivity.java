...
public class StockFriendsSearchFriednsActivity extends Activity {
	...
	@OnClick({ R.id.rl_title_note, R.id.rl_weixin_friends, R.id.rl_qq_friends,
			R.id.rl_weibo_friends, R.id.rl_phone_friends })
	private void Onclick(View view) {
		switch (view.getId()) {
		case R.id.rl_title_note:
			finish();
			break;
		...
		case R.id.rl_phone_friends:
			Intent intent = new Intent(StockFriendsSearchFriednsActivity.this,
