 ...
 * request body.
 */
public class VoidRequest extends JsonRequest<Void> {
	 ...
	 */
	public VoidRequest(int method, String url, JSONObject jsonRequest,
	 ...
	 */
	public VoidRequest(String url, JSONObject jsonRequest,
			Listener<Void> listener, ErrorListener errorListener) {
